...
theorem Manhattan.Frozen.Operator.fiberS_selfAdjoint : ∀ {E : Type u_1} [_inst : NormedAddCommGroup E]
  [_inst_1 : InnerProductSpace ℂ E] [_inst_2 : CompleteSpace E] (D : Manhattan.Operator.FiberEnvironment E)
  (p : Fin 2 → ℝ), IsSelfAdjoint (D.fiberS p)
-- FROZEN-STATEMENT-END
:= @Manhattan.Operator.FiberEnvironment.fiberS_selfAdjoint
