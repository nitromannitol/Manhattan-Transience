...
* and derives the three main conclusions from (23)
...
`ConcreteDThreeRaisingBound` is **no longer on the route to (23)**.  The development
...
/-! ### The three main conclusions, from (23) -/
