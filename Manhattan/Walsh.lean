...
/-!
# Fourier--Walsh coordinates

The degree indexing uses finite sets of distinct line indices, in accordance
with.  In particular, no tuple symmetrization or factorial
